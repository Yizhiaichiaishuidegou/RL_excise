...
class Render:
    ...
    def show_frame(self, t: float = 1000.0) -> None:
        """
        显示figure 持续一段时间后 关闭
        :param t: 持续时间
        :return: None
    ...
    def save_frame(self, name: str) -> None:
        ...
        parent_dir = current_dir.parent.parent  # 上一级目录
...
if __name__ == '__main__':
    ...
    for num in range(1):
        render.draw_random_line(pos1=[0, 0], pos2=[1.5, 2.5])
